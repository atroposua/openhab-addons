...
/**
 * The {@link ADBHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
 * @author Atropos - Initial contribution
 */
@NonNullByDefault
@Component(configurationPid = "binding.adb", service = ThingHandlerFactory.class)
public class ADBHandlerFactory extends BaseThingHandlerFactory {
