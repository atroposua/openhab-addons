...
public class SnapcastMethodClientOnConnect<T> extends SnapcastMethodClient {
    public SnapcastMethodClientOnConnect(final Map<String, Client> clientMap, final SnapcastController controller) {
